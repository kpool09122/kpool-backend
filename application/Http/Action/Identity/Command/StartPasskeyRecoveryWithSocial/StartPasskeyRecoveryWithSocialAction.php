...
readonly class StartPasskeyRecoveryWithSocialAction
{
    public function __construct(
        private StartPasskeyRecoveryWithSocialInterface $useCase,
    ...
    public function __invoke(StartPasskeyRecoveryWithSocialRequest $request): JsonResponse
    {
        try {
            try {
