...
use Source\Wiki\Image\Application\UseCase\Command\RejectImageDeletion\RejectImageDeletionInterface;
...
readonly class RejectImageDeletionAction
{
    public function __construct(
        private RejectImageDeletionInterface $rejectImageDeletionRequest,
    ...
    /**
     * @param RejectImageDeletionRequest $request
     * @return JsonResponse
     * @throws InternalServerErrorHttpException
     */
    public function __invoke(RejectImageDeletionRequest $request): JsonResponse
    {
        try {
            try {
            ...
            try {
                $this->rejectImageDeletionRequest->process($input, $output);
                DB::commit();
            ...
            } catch (ImageDeletionRequestNotPendingException $e) {
                DB::rollBack();
                $this->logger->error((string) $e);

                throw new ConflictHttpException(detail: error_message('image_deletion_request_not_pending_for_rejection', $language), previous: $e);
