...
readonly class ApproveImageDeletionAction
{
    public function __construct(
        private ApproveImageDeletionInterface $approveImageDeletionRequest,
    ...
    /**
     * @param ApproveImageDeletionRequest $request
     * @return JsonResponse
     * @throws InternalServerErrorHttpException
     */
    public function __invoke(ApproveImageDeletionRequest $request): JsonResponse
    {
        try {
            try {
            ...
            try {
                $this->approveImageDeletionRequest->process($input, $output);
                DB::commit();
                ...
                throw new ConflictHttpException(detail: error_message('image_deletion_request_not_pending_for_approval', $language), previous: $e);
