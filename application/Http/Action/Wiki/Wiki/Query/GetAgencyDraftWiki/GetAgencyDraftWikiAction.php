...
readonly class GetAgencyDraftWikiAction
{
    public function __construct(
        private GetAgencyDraftWikiInterface $getAgencyDraftWiki,
     ...
     */
    public function __invoke(GetAgencyDraftWikiRequest $request): JsonResponse
    {
        try {
            try {
                $input = new GetAgencyDraftWikiInput(
            ...
            try {
                $readModel = $this->getAgencyDraftWiki->process($input);
