...
namespace Application\Http\Action\Wiki\Wiki\Query\GetMySongDraftWiki;
...
readonly class GetMySongDraftWikiAction
{
    public function __construct(
        private GetMySongDraftWikiInterface $getMySongDraftWiki,
    ...
    public function __invoke(GetMySongDraftWikiRequest $request): JsonResponse
    {
        try {
            try {
                $input = new GetMySongDraftWikiInput(
            ...
            try {
                $readModel = $this->getMySongDraftWiki->process($input);
