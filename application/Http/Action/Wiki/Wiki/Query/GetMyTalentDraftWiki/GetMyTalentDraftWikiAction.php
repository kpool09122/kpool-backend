...
readonly class GetMyTalentDraftWikiAction
{
    ...
    public function __invoke(GetMyTalentDraftWikiRequest $request): JsonResponse
    {
        try {
            try {
            ...
            try {
                $readModel = $this->getMyTalentDraftWiki->process($input);
