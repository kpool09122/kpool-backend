...
namespace Application\Http\Action\Wiki\Wiki\Query\GetMyGroupDraftWiki;
...
readonly class GetMyGroupDraftWikiAction
{
    public function __construct(
        private GetMyGroupDraftWikiInterface $getMyGroupDraftWiki,
    ...
    public function __invoke(GetMyGroupDraftWikiRequest $request): JsonResponse
    {
        try {
            try {
                $input = new GetMyGroupDraftWikiInput(
            ...
            try {
                $readModel = $this->getMyGroupDraftWiki->process($input);
