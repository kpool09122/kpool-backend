...
readonly class ApproveWikiAction
{
    ...
    /**
     * @param ApproveWikiRequest $request
     * @return JsonResponse
     * @throws InternalServerErrorHttpException
     */
    public function __invoke(ApproveWikiRequest $request): JsonResponse
    {
        try {
            try {
            ...
            try {
                $this->approveWiki->process($input, $output);
                DB::commit();
            ...
            } catch (ExistsApprovedDraftWikiException $e) {
                DB::rollBack();
                $this->logger->error((string) $e);
