...
readonly class RequestAccountCategoryChangeAction
{
    ...
    public function __invoke(RequestAccountCategoryChangeRequest $request): JsonResponse
    {
        try {
            ...
            try {
                $input = new RequestAccountCategoryChangeInput(new AccountIdentifier($request->accountIdentifier()), $this->accountContext->principal(), $request->requestedAccountCategory());
