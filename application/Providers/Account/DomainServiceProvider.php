...
use Source\Account\Account\Infrastructure\Factory\AccountTypeChangeRequestFactory;
...
class DomainServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        $this->app->singleton(AccountTypeChangeRequestFactoryInterface::class, AccountTypeChangeRequestFactory::class);
        $this->app->singleton(AccountTypeChangeRequestRepositoryInterface::class, AccountTypeChangeRequestRepository::class);
