...
class DomainServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        $this->app->singleton(PasskeyUserFactoryInterface::class, PasskeyUserFactory::class);
        ...
        $this->app->singleton(PasskeyUserRepositoryInterface::class, PasskeyUserRepository::class);
        $this->app->singleton(ChallengeSessionStorageServiceInterface::class, ChallengeSessionStorageService::class);
        $this->app->singleton(PasskeyRecoveryEmailVerificationServiceInterface::class, PasskeyRecoveryEmailVerificationService::class);
