...
#[\Illuminate\Database\Eloquent\Attributes\Table(name: 'draft_wiki_talent_basics', key: 'wiki_id', keyType: 'string')]
class DraftWikiTalentBasic extends Model
{
    #[\Override]
    public $incrementing = false;

    /**
     * @return BelongsTo<DraftWiki, DraftWikiTalentBasic>
     */
    ...
    {
        return $this->belongsToMany(Wiki::class, 'draft_wiki_talent_basic_groups', 'wiki_id', 'group_identifier');
    }
}
