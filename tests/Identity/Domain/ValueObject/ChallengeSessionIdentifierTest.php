...
class ChallengeSessionIdentifierTest extends TestCase
{
    public function testItAcceptsAUuidVersion7(): void
    {
        $value = '123e4567-e89b-72d3-a456-426614174010';

        $this->assertSame($value, (string) new ChallengeSessionIdentifier($value));
    }
    ...
    public function testItRejectsAnInvalidIdentifier(string $value): void
    {
        ...
        new ChallengeSessionIdentifier($value);
    }
