...
class DemotionWarningsBatchIssuedHandlerTest extends TestCase
{
    /**
     * 正しくDIが動作していること.
     *
    ...
    /**
     * 正常系: 複数のidentityに対して降格警告メールが送信されること.
     *
     * @return void
     * @throws BindingResolutionException
     */
    public function testHandleSendsDemotionWarningToMultipleIdentities(): void
    {
        ...
        $event = new DemotionWarningsBatchIssued(
        ...
        $notificationService = Mockery::mock(CollaboratorNotificationServiceInterface::class);
        $notificationService->shouldReceive('sendDemotionWarning')
