...
class CreateDraftWiki
{
     ...
     */
    public static function create(string $draftWikiId, string $resourceType, array $overrides = [], array $basicOverrides = []): void
    {
        ...
        match ($resourceType) {
            'group' => self::createGroupBasic($draftWikiId, $basicOverrides),
    ...
    {
        DB::table('draft_wiki_group_basics')->insert([
            'wiki_id' => $wikiId,
    ...
    {
        DB::table('draft_wiki_agency_basics')->insert([
            'wiki_id' => $wikiId,
