...
class CreateWikiSnapshot
{
     ...
     */
    public static function create(string $snapshotId, string $resourceType, array $overrides = [], array $basicOverrides = []): void
    {
        $wikiId = $overrides['wiki_id'] ?? StrTestHelper::generateUuid();

        // wiki_snapshots has a foreign key to wikis, so ensure the parent wiki exists.
        ...
        match ($resourceType) {
            'group' => self::createGroupBasic($snapshotId, $basicOverrides),
     ...
     */
    private static function createGroupBasic(string $snapshotId, array $overrides = []): void
    {
        DB::table('wiki_snapshot_group_basics')->insert([
     ...
     * @param array<string, mixed> $overrides
     */
    private static function createAgencyBasic(string $snapshotId, array $overrides = []): void
    {
        DB::table('wiki_snapshot_agency_basics')->insert([
            'snapshot_id' => $snapshotId,
