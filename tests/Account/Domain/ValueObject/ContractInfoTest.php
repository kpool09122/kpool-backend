...
class ContractInfoTest extends TestCase
{
    /**
    ...
    public function test__construct(): void
    {
        ...
        $this->assertSame($address, $contractInfo->billingAddress());
        $this->assertSame($contact, $contractInfo->billingContact());
        $this->assertSame($method, $contractInfo->billingMethod());
        $this->assertSame($plan, $contractInfo->plan());
        $this->assertSame($taxInfo, $contractInfo->taxInfo());
        $this->assertSame($startDate, $contractInfo->billingStartDate());
    }
}
