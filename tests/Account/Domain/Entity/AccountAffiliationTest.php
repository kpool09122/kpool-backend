...
class AccountAffiliationTest extends TestCase
{
    ...
    private function createPendingAffiliation(): AccountAffiliation
    {
    ...
    private function createActiveAffiliation(): AccountAffiliation
    {
        return new AccountAffiliation(
            new AffiliationIdentifier(StrTestHelper::generateUuid()),
            new AccountIdentifier(StrTestHelper::generateUuid()),
    ...
    private function createTerminatedAffiliation(): AccountAffiliation
    {
        return new AccountAffiliation(
            new AffiliationIdentifier(StrTestHelper::generateUuid()),
            new AccountIdentifier(StrTestHelper::generateUuid()),
