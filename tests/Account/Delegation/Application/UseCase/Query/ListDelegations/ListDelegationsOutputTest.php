...
class ListDelegationsOutputTest extends TestCase
{
    public function testToArrayReturnsDelegationsAndPagination(): void
    {
        ...
        $output->output([new DelegationReadModel(
            ...
            'delegator-id',
            'requester-id',
            ['accountIdentifier' => 'delegate-id', 'name' => 'Delegate Account', 'email' => 'delegate@example.test'],
            ['accountIdentifier' => 'delegator-id', 'name' => 'Delegator Account', 'email' => 'delegator@example.test'],
            ['accountIdentifier' => 'requester-id', 'name' => 'Requester Account', 'email' => 'requester@example.test'],
            'approved',
            'from_agency',
        ...
        $this->assertSame([
            'delegations' => [[
                ...
                'delegateAccount' => ['accountIdentifier' => 'delegate-id', 'name' => 'Delegate Account', 'email' => 'delegate@example.test'],
                'delegatorAccount' => ['accountIdentifier' => 'delegator-id', 'name' => 'Delegator Account', 'email' => 'delegator@example.test'],
                'requestedByAccount' => ['accountIdentifier' => 'requester-id', 'name' => 'Requester Account', 'email' => 'requester@example.test'],
                'status' => 'approved',
