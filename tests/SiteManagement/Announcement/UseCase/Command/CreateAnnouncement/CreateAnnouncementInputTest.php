...
use Businesses\SiteManagement\Announcement\UseCase\Command\CreateAnnouncement\CreateAnnouncementInput;
use DateTimeImmutable;
use Tests\TestCase;

class CreateAnnouncementInputTest extends TestCase
{
    /**
     * 正常系: インスタンスが生成されること
     *
