...
use Source\Wiki\Image\Application\UseCase\Command\RejectImageDeletion\RejectImageDeletion;
...
class RejectImageDeletionTest extends TestCase
{
    /**
     * 正常系: インスタンスが生成されること.
     *
    ...
    /**
     * 正常系：正しくdeletionRequestが却下されること.
     *
     * @throws BindingResolutionException
     */
