...
class RejectImageHideRequestTest extends TestCase
{
    ...
    public function testProcess(): void
    {
        ...
        $input = new RejectImageHideRequestInput($imageIdentifier, $principalIdentifier, 'Not applicable');
    ...
    public function testProcessImageNotFound(): void
    {
        ...
        $principalIdentifier = new PrincipalIdentifier(StrTestHelper::generateUuid());
        $input = new RejectImageHideRequestInput($imageIdentifier, $principalIdentifier, 'comment');
