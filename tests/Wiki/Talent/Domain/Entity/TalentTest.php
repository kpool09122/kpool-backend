...
class TalentTest extends TestCase
{
    ...
    public function test__construct(): void
    {
        ...
        $this->assertSame((string)$talentInfo->editorIdentifier, (string)$talentInfo->talent->editorIdentifier());
        $this->assertSame((string) $talentInfo->approverIdentifier, (string)$talentInfo->talent->approverIdentifier());
