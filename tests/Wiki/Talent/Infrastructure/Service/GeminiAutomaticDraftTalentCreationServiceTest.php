...
use Source\Wiki\Talent\Infrastructure\Service\GeminiAutomaticDraftTalentCreationService;
use Tests\Helper\StrTestHelper;
use Tests\TestCase;

class GeminiAutomaticDraftTalentCreationServiceTest extends TestCase
{
    /**
     * 正しくDIが動作していること.
     *
    ...
    {
        $service = $this->app->make(AutomaticDraftTalentCreationServiceInterface::class);

        $this->assertInstanceOf(GeminiAutomaticDraftTalentCreationService::class, $service);
    }
...
DESCRIPTION;
    ...
    private function makePayload(string $name, Language $language): AutomaticDraftTalentCreationPayload
    {
