...
class SubmitUpdatedSongTest extends TestCase
{
    /**
     * 正常系: インスタンスが生成されること
     *
    ...
    public function test__construct(): void
    {
        ...
        $submitUpdatedSong = $this->app->make(SubmitUpdatedSongInterface::class);
        $this->assertInstanceOf(SubmitUpdatedSong::class, $submitUpdatedSong);
    }
    ...
    public function testProcess(): void
    {
        ...
        $this->app->instance(SongRepositoryInterface::class, $songRepository);
        $submitUpdatedSong = $this->app->make(SubmitUpdatedSongInterface::class);
        $song = $submitUpdatedSong->process($input);
    ...
    public function testWhenNotFoundAgency(): void
    {
        ...
        $submitUpdatedSong = $this->app->make(SubmitUpdatedSongInterface::class);
        $submitUpdatedSong->process($input);
    }
