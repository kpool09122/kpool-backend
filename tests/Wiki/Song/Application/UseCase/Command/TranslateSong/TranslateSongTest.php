...
class TranslateSongTest extends TestCase
{
    ...
    private function createDummyTranslateSong(): TranslateSongTestData
    {
        ...
        $jaNormalizedLyricist = 'black eyed pilseung';
        $jaComposer = new Composer('Sam Lewis');
        $jaNormalizedComposer = 'sam lewis';
        ...
        $jaSong = new DraftSong(
            ...
            $jaTalentIdentifier,
            $jaLyricist,
            $jaNormalizedLyricist,
            $jaComposer,
            $jaNormalizedComposer,
            $jaReleaseDate,
            $jaOverView,
            $jaCoverImagePath,
            $jaMusicVideoLink,
        ...
        $enNormalizedLyricist = 'black eyed pilseung';
        $enComposer = new Composer('Sam Lewis');
        $enNormalizedComposer = 'sam lewis';
        ...
        $enSong = new DraftSong(
            ...
            $enTalentIdentifier,
            $enLyricist,
            $enNormalizedLyricist,
            $enComposer,
            $enNormalizedComposer,
            $enReleaseDate,
            $enOverView,
            $enCoverImagePath,
            $enMusicVideoLink,
