...
class RejectSongTest extends TestCase
{
    ...
    /**
     * 異常系：GROUP_ACTORが自分の所属していないグループの楽曲を却下しようとした場合、例外がスローされること.
     *
     * @return void
     * @throws BindingResolutionException
     * @throws SongNotFoundException
    ...
    /**
     * 正常系：GROUP_ACTORが自分の所属するグループの楽曲を却下できること.
     *
     * @return void
     * @throws BindingResolutionException
     * @throws SongNotFoundException
    ...
    /**
     * 異常系：TALENT_ACTORが自分の所属していないグループの楽曲を却下しようとした場合、例外がスローされること.
     *
     * @return void
     * @throws BindingResolutionException
     * @throws SongNotFoundException
    ...
    /**
     * 正常系：TALENT_ACTORが自分の所属するグループの楽曲を却下できること.
     *
     * @return void
     * @throws BindingResolutionException
     * @throws SongNotFoundException
    ...
    /**
     * 正常系：SENIOR_COLLABORATORが曲を却下できること.
     *
     * @return void
     * @throws BindingResolutionException
     * @throws SongNotFoundException
    ...
    /**
     * 異常系：NONEロールが曲を却下しようとした場合、例外がスローされること.
     *
     * @return void
     * @throws BindingResolutionException
     * @throws SongNotFoundException
