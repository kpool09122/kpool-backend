...
class ApproveUpdatedSongTest extends TestCase
{
    /**
     * 正常系: インスタンスが生成されること
     *
    ...
    public function test__construct(): void
    {
        ...
        $approveUpdatedSong = $this->app->make(ApproveUpdatedSongInterface::class);
        $this->assertInstanceOf(ApproveUpdatedSong::class, $approveUpdatedSong);
    }
    ...
    public function testProcess(): void
    {
        ...
        $this->app->instance(SongServiceInterface::class, $songService);
        $approveUpdatedSong = $this->app->make(ApproveUpdatedSongInterface::class);
        $song = $approveUpdatedSong->process($input);
    ...
    public function testWhenNotFoundMember(): void
    {
        ...
        $approveUpdatedSong = $this->app->make(ApproveUpdatedSongInterface::class);
        $approveUpdatedSong->process($input);
    }
