...
class DraftSongTest extends TestCase
{
     ...
     * @return void
     */
    public function testSePublishedSongIdentifier(): void
    {
        $songIdentifier = new SongIdentifier(StrTestHelper::generateUlid());
        $publishedSongIdentifier = new SongIdentifier(StrTestHelper::generateUlid());
        $editorIdentifier = new EditorIdentifier(StrTestHelper::generateUlid());
        ...
        $song->setPublishedSongIdentifier($newPublishedSongIdentifier);
        $this->assertNotSame((string)$publishedSongIdentifier, (string)$song->publishedSongIdentifier());
        $this->assertSame((string)$newPublishedSongIdentifier, (string)$song->publishedSongIdentifier());
    }
    ...
    public function testSetStatus(): void
    {
        ...
        $this->assertSame($newStatus, $song->status());
    }
}
