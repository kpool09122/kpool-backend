...
class GeminiAutomaticDraftAgencyCreationServiceTest extends TestCase
{
    /**
     * 正しくDIが動作していること.
     *
    ...
    {
        $service = $this->app->make(AutomaticDraftAgencyCreationServiceInterface::class);

        $this->assertInstanceOf(GeminiAutomaticDraftAgencyCreationService::class, $service);
    }
