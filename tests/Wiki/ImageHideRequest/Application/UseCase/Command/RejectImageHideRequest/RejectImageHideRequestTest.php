...
class RejectImageHideRequestTest extends TestCase
{
    /**
     * 正常系: インスタンスが生成されること
     *
    ...
    public function test__construct(): void
    {
        ...
        $this->assertInstanceOf(RejectImageHideRequest::class, $rejectImageHideRequest);
    }

    /**
     * 正常系：正しくImageHideRequestがRejectedステータスに変更されること.
     *
     * @return void
     * @throws BindingResolutionException
    ...
    public function testProcessImageHideRequestNotFound(): void
    {
        ...
        $principalIdentifier = new PrincipalIdentifier(StrTestHelper::generateUuid());
        $input = new RejectImageHideRequestInput($requestIdentifier, $principalIdentifier, 'comment');
    ...
    {
        $testData = $this->createTestData(ImageHideRequestStatus::REJECTED);
        $principalIdentifier = new PrincipalIdentifier(StrTestHelper::generateUuid());
        $input = new RejectImageHideRequestInput($testData->requestIdentifier, $principalIdentifier, 'comment');
     ...
     * @return RejectImageHideRequestTestData
     */
    private function createTestData(ImageHideRequestStatus $status = ImageHideRequestStatus::PENDING): RejectImageHideRequestTestData
    {
        $requestIdentifier = new ImageHideRequestIdentifier(StrTestHelper::generateUuid());
        ...
        return new RejectImageHideRequestTestData(
            $requestIdentifier,
            $imageIdentifier,
            $imageHideRequest,
            $image,
 ...
 * テストデータを保持するクラス
 */
readonly class RejectImageHideRequestTestData
{
