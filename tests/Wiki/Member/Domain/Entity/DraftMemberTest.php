...
지금까지의 경력을 통해 쌓아온 \'고객의 과제를 정확하게 파악하는 능력\'과 \'데이터를 기반으로 전략을 세우고 실행하는 능력\'을 활용하여 귀사의 사업 성장에 기여하고 싶습니다. 앞으로는 영업과 마케팅 양쪽의 시각을 겸비한 강점을 살려 보다 효과적인 고객 접근을 실현할 수 있다고 확신합니다.');
        ...
        $this->assertSame((string)$editIdentifier, (string)$member->editorIdentifier());
    ...
    /**
     * 正常系：公開済みMemberIDのsetterが正しく動作すること.
     *
     * @throws ExceedMaxRelevantVideoLinksException
     * @return void
     */
    public function testSetPublishedMemberIdentifier(): void
    {
        $memberIdentifier = new MemberIdentifier(StrTestHelper::generateUlid());
        $publishedMemberIdentifier = new MemberIdentifier(StrTestHelper::generateUlid());
        $editIdentifier = new EditorIdentifier(StrTestHelper::generateUlid());
...
지금까지의 경력을 통해 쌓아온 \'고객의 과제를 정확하게 파악하는 능력\'과 \'데이터를 기반으로 전략을 세우고 실행하는 능력\'을 활용하여 귀사의 사업 성장에 기여하고 싶습니다. 앞으로는 영업과 마케팅 양쪽의 시각을 겸비한 강점을 살려 보다 효과적인 고객 접근을 실현할 수 있다고 확신합니다.');
        ...
        $newPublishedMemberIdentifier = new MemberIdentifier(StrTestHelper::generateUlid());
        $member->setPublishedMemberIdentifier($newPublishedMemberIdentifier);
        $this->assertNotSame((string)$publishedMemberIdentifier, (string)$member->publishedMemberIdentifier());
        $this->assertSame((string)$newPublishedMemberIdentifier, (string)$member->publishedMemberIdentifier());
    }
...
지금까지의 경력을 통해 쌓아온 \'고객의 과제를 정확하게 파악하는 능력\'과 \'데이터를 기반으로 전략을 세우고 실행하는 능력\'을 활용하여 귀사의 사업 성장에 기여하고 싶습니다. 앞으로는 영업과 마케팅 양쪽의 시각을 겸비한 강점을 살려 보다 효과적인 고객 접근을 실현할 수 있다고 확신합니다.');
        ...
        $member->setRelevantVideoLinks($newRelevantVideoLinks);
        $this->assertNotSame($relevantVideoLinks->toStringArray(), $member->relevantVideoLinks()->toStringArray());
        $this->assertSame($newRelevantVideoLinks->toStringArray(), $member->relevantVideoLinks()->toStringArray());
    }
...
지금까지의 경력을 통해 쌓아온 \'고객의 과제를 정확하게 파악하는 능력\'과 \'데이터를 기반으로 전략을 세우고 실행하는 능력\'을 활용하여 귀사의 사업 성장에 기여하고 싶습니다. 앞으로는 영업과 마케팅 양쪽의 시각을 겸비한 강점을 살려 보다 효과적인 고객 접근을 실현할 수 있다고 확신합니다.');
        ...
        $this->assertSame($newStatus, $member->status());
    }
}
