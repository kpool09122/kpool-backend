...
class ApproveUpdatedMemberTest extends TestCase
{
    /**
     * 正常系: インスタンスが生成されること
     *
    ...
    public function test__construct(): void
    {
        ...
        $approveUpdatedMember = $this->app->make(ApproveUpdatedMemberInterface::class);
        $this->assertInstanceOf(ApproveUpdatedMember::class, $approveUpdatedMember);
    }
...
지금까지의 경력을 통해 쌓아온 \'고객의 과제를 정확하게 파악하는 능력\'과 \'데이터를 기반으로 전략을 세우고 실행하는 능력\'을 활용하여 귀사의 사업 성장에 기여하고 싶습니다. 앞으로는 영업과 마케팅 양쪽의 시각을 겸비한 강점을 살려 보다 효과적인 고객 접근을 실현할 수 있다고 확신합니다.');
        ...
        $this->app->instance(MemberServiceInterface::class, $memberService);
        $approveUpdatedMember = $this->app->make(ApproveUpdatedMemberInterface::class);
        $member = $approveUpdatedMember->process($input);
    ...
    public function testWhenNotFoundMember(): void
    {
        ...
        $approveUpdatedMember = $this->app->make(ApproveUpdatedMemberInterface::class);
        $approveUpdatedMember->process($input);
    }
