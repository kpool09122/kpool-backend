...
class GeminiAutomaticDraftGroupCreationServiceTest extends TestCase
{
    /**
     * 正しくDIが動作していること.
     *
    ...
    {
        $service = $this->app->make(AutomaticDraftGroupCreationServiceInterface::class);

        $this->assertInstanceOf(GeminiAutomaticDraftGroupCreationService::class, $service);
    }
...
DESCRIPTION;
    ...
    private function makePayload(string $name, Language $language): AutomaticDraftGroupCreationPayload
    {
