...
class TranslateGroupTest extends TestCase
{
    ...
    public function testAuthorizedGroupActor(): void
    {
        ...
        $principalIdentifier = new PrincipalIdentifier(StrTestHelper::generateUuid());
        $principal = new Principal($principalIdentifier, new IdentityIdentifier(StrTestHelper::generateUuid()), Role::GROUP_ACTOR, null, [(string) $dummyTranslateGroup->groupIdentifier], []);
