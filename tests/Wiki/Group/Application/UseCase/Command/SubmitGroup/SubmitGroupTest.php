...
class SubmitGroupTest extends TestCase
{
    ...
    public function testProcess(): void
    {
        ...
        $status = $dummySubmitGroup->status;
    ...
    public function testInvalidStatus(): void
    {
        ...
        $group = new DraftGroup(
            $dummySubmitGroup->groupIdentifier,
            $dummySubmitGroup->publishedGroupIdentifier,
            $dummySubmitGroup->translationSetIdentifier,
            $dummySubmitGroup->editorIdentifier,
            $dummySubmitGroup->language,
            $dummySubmitGroup->name,
            'twice',
            $dummySubmitGroup->agencyIdentifier,
            $dummySubmitGroup->description,
            $dummySubmitGroup->songIdentifiers,
            $dummySubmitGroup->imagePath,
            $status,
        );
    ...
    {
        $dummySubmitGroup = $this->createDummySubmitGroup();
        $agencyId = (string) $dummySubmitGroup->agencyIdentifier;
    ...
    public function testProcessWithGroupActor(): void
    {
        ...
        $principalIdentifier = new PrincipalIdentifier(StrTestHelper::generateUlid());
        $principal = new Principal($principalIdentifier, Role::GROUP_ACTOR, null, [(string) $dummySubmitGroup->groupIdentifier], []);
    ...
    public function testProcessWithMemberActor(): void
    {
        ...
        $principal = new Principal($principalIdentifier, Role::TALENT_ACTOR, null, [(string) $dummySubmitGroup->groupIdentifier], [$memberId]);
     ...
     */
    private function createDummySubmitGroup(): SubmitGroupTestData
    {
