...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('wiki_talent_basics', static function (Blueprint $table) {
            ...
            $table->jsonb('group_identifiers')->default('[]')->comment('所属グループID配列');
        ...
        Schema::create('wiki_song_basics', static function (Blueprint $table) {
            ...
            $table->jsonb('group_identifiers')->default('[]')->comment('グループID配列');
            $table->jsonb('talent_identifiers')->default('[]')->comment('タレントID配列');
        ...
        // 既存テーブルから basic カラムを削除
        Schema::table('wikis', static function (Blueprint $table) {
            $table->dropColumn('basic');
        });

        Schema::table('draft_wikis', static function (Blueprint $table) {
            $table->dropColumn('basic');
        });

        Schema::table('wiki_snapshots', static function (Blueprint $table) {
            $table->dropColumn('basic');
        });
    }
    ...
    public function down(): void
    {
        // basic カラムを復元
        Schema::table('wikis', static function (Blueprint $table) {
            $table->jsonb('basic')->after('resource_type')->comment('Basic情報（ポリモーフィック）');
        });
        ...
        Schema::table('wiki_snapshots', static function (Blueprint $table) {
            $table->jsonb('basic')->after('resource_type')->comment('Basic情報');
        });
