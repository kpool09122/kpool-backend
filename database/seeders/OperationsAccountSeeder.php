...
class OperationsAccountSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $ownerRoleId = DB::table('account_roles')->where('name', Role::OWNER)->value('id');
        ...
        $administratorRoleId = DB::table('wiki_roles')->where('name', 'ADMINISTRATOR')->value('id');
        ...
        DB::table('wiki_principal_groups')->upsert([
            [
        ...
        DB::table('wiki_principal_group_memberships')->upsert([[
        ...
        DB::table('wiki_principal_group_role_attachments')->upsert([[
            'principal_group_id' => $wikiPrincipalGroupId,
